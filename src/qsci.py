...
from PyQt4.Qsci import QsciScintilla, QsciScintillaBase, QsciLexerPython,QsciAPIs

class QsciLexerPython1(QsciLexerPython):

    def __init__(self, parent=None):
        super(QsciLexerPython1, self).__init__(parent)
